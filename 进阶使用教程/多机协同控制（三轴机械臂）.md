...
```shell
cd Damiao_Motor_Control_Tutorial/examples/ROS2_Control_example
```

如果只下载源码，也可以直接下载：

```shell
examples/ROS2_Control_example
```
...
```shell
cd Damiao_Motor_Control_Tutorial/examples/ROS2_Control_Multi_example
```

如果只下载源码，也可以直接下载：

```shell
examples/ROS2_Control_Multi_example
```
